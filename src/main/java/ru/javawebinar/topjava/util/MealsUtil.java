...
public class MealsUtil {
    public static void main(String[] args) {
        List<Meal> meals = generateListMeals();
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
        ...
        return meals.stream()
                .filter(startTime != null && endTime != null ?
                        meal -> TimeUtil.isBetweenHalfOpen(meal.getTime(), startTime, endTime) : meal -> true)
    ...
    public static List<Meal> generateListMeals() {
